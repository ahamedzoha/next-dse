...
const defaultMeta = {
  title: 'DSE Stockfolio',
  siteName: 'DSE Stockfolio',
  description:
    'Manage your Dhaka Stock Exchange stock portfolio and get the latest stock market news',
  /** Without additional '/' on the end, e.g. https://theodorusclarence.com */
  url: 'https://dse.azazahamed.com',
  type: 'website',
  robots: 'follow, index',
  /**
